...
export default function AccessGate(){
 ...
 if(!ready||!allowed)return <main className="access-welcome"><div><small>私人图像工作站</small><h1>俞总和小吴的<br/>图像生成工作站</h1><p>{!ready?'正在打开你的创作空间…':error||'请通过主人分享的专属链接进入，无需登录。'}</p>{ready&&<a href="/manage">工作电脑管理入口</a>}</div></main>;
